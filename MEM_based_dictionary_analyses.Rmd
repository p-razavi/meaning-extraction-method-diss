...
theme_1 <- extract_top_words_weights(pattern_matrix, component = RC1)
theme_2 <- extract_top_words_weights(pattern_matrix, component = RC2)
theme_3 <- extract_top_words_weights(pattern_matrix, component = RC3)
theme_4 <- extract_top_words_weights(pattern_matrix, component = RC4)
theme_5 <- extract_top_words_weights(pattern_matrix, component = RC5)
theme_6 <- extract_top_words_weights(pattern_matrix, component = RC6)
theme_7 <- extract_top_words_weights(pattern_matrix, component = RC7)
theme_8 <- extract_top_words_weights(pattern_matrix, component = RC8)
